...
const { downloadTrack, isTrackDownloaded, removeDownloadedTrack } = useOffline();
    ...
    >
      <div class="trackCell">
        <div class="flex items-center gap-2">
          ...
          <!-- Downloaded offline indicator pill badge -->
          <span
            v-if="isTrackDownloaded(track.id)"
            class="inline-flex items-center justify-center p-1 text-xs font-bold text-black bg-neo-green border border-black rounded-full shadow-neo-sm"
      ...
      <div class="trackCell trackOptions desktopOnly">
        <DropdownMenu ref="dropdownMenuRef">
          ...
          <DropdownItem
            v-else
            ref="removeTrackOffline"
            @click="removeDownloadedTrack(track.id)"
          >
